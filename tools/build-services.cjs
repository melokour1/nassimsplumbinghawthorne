...
<!-- ##### SECTION: ANALYTICS #####
     Vercel Web Analytics and Speed Insights. Served from this domain so
     blocklists that catch cdn.vercel-insights.com do not skew the numbers.
     Cookieless: no cross-site identifier, nothing to consent to. -->
